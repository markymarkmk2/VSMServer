 ...
 */
public class NodePathResolver extends PathResolver
{
    
    FileSystemElemNode rootDir;

    public NodePathResolver(FileSystemElemNode rootDir, StoragePoolHandler h)
    {
        super(h);
...
//        rootDir.setChildren(context.resultList);
    }
