...
public abstract class VsmResource implements Resource, MoveableResource, CopyableResource, LockableResource, DigestResource {
    ...
    public VsmResource(String host, VsmDavResourceFactory factory, FileSystemElemNode file) {
        this.host = host;
        this.file = file;
    ...
    public String getUniqueId() {
        String s = file.getIdx() + "_" ;//+ file.getPool().getIdx();
        return s.hashCode() + "";
    }
    ...
    public Date getModifiedDate() {
        return new Date(file.getAttributes().getModificationDateMs());
    }

    public Date getCreateDate() {
        return new Date(file.getAttributes().getCreationDateMs());
    }
