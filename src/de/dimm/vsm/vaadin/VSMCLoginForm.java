...
public class VSMCLoginForm extends CustomComponent
{
    ...
    private String usernameCaption = GenericMain.Txt("Username");
    private String passwordCaption = GenericMain.Txt("Password");
    private String loginButtonCaption = GenericMain.Txt("Login");
